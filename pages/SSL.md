...
- ## export pfx
  ...
  `cat ssl_certificate.cer > a.cer` `cat IntermediateCA.cer >> a.cer`
...
- ### Encode
  - 2 encoding formats:
    - Base64
      - PEM `Base64 ---- BEGIN CERTIFICATE ---- headers` Is a container format.
        Can container private key or both private and public keys
    - Binary
      - DER
- ## Verify SSL chain

...
- [[Decisions]]
  - [[Tooling]]
    ...
    - [[VSCode]] installation: ==Don't use nix==. It needs a
      [FHS compliant environment](https://nixos.wiki/wiki/Visual_Studio_Code)
      which doesn't work well in Mac
  - Mac vs Linux
    - [[Mac]]
      - Linux difficult to use at Work
      - Using Linux just at home doesn't work due context switch pain
- [[Nix]]
  - CLI id:: 676159ab-f29c-4547-9942-0d5c5e6bca71
    - update ==with flakes== `nix flake update`

      ==without flakes== Each user has own channels. Use `root` channels
      `sudo nix-channel --update darwin`

    - change log `darwin-rebuild changelog`
    - switch to the updated flake `darwin-rebuild switch  --flake .`
- [[logseq]]
  - Convert obsidian
